...
if __name__ == "__main__":
    ...
    elb_list = ELB.listElb( elb_name_pattern, vpc_id_list, elb_tags ) 

    # Remove all elbs via arn
    elb_arn_list = [lb['LoadBalancerArn'] for lb in elb_list]
    output = ELB.remove( elb_arn_list )
    [print(lb_arn) for lb_arn in output]
