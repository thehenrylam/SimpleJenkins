...
if __name__ == "__main__":
    ...
    filter_eci_tags = ConvertTagsToFilter( default_tags )
    eci_list = EC2.listInstances( filter_eci_tags, vpc_filters )
    ...
    for tgt in tgt_list:
        r = ELB.registerTgt_instances_ip( tgt['TargetGroupArn'], eci_list )
        print( r )
